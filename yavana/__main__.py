...
from yavana.modules import ALL_MODULES
from yavana.modules.purge import client
from yavana.modules.helper_funcs.chat_status import is_user_admin
from yavana.modules.helper_funcs.filters import CustomFilters
from yavana.modules.helper_funcs.misc import paginate_modules
from yavana.modules.helper_funcs.alternate import typing_action


PM_START_TEXT = f"""
`Hi..Welcome` 
`i am [yavana](https://telegra.ph/file/711c5c78c5fa5adc48f2f.jpg) . i bot for help the admins to manage this wonderfull group with extra features`
"""

buttons = [[InlineKeyboardButton(text=" സഹായം ",
                                  callback_data="help_back"),
]]

buttons += [[InlineKeyboardButton(text="എന്നെ ഗ്രൂപ്പിൽ ചേർക്കൂ",
                                  url="t.me/yavana_TgBot?startgroup=true"),
]]

buttons += [[InlineKeyboardButton(text="എൻ്റെ അഡ്രസ്സ്",
                                  url=("വാങ്ങിയതാണ അതോ ടെസ്റ്റ് ട്യൂബ് ആണോ?"),inlineKeyboardButton(text="സപ്പോർട്ട്",
                text="നോക്കി ഇരുന്നോ .... ഇപ്പൊ കിട്ടും .... "),
]]

buttons += [[InlineKeyboardButton(text="അടച്ചിട്ട് പോകൂ",
                                  callback_data="close_menu")]]


HELP_STRINGS = f"""
`Hi..Welcome` 
`i am [yavana](https://telegra.ph/file/711c5c78c5fa5adc48f2f.jpg)'
`താഴെയുള്ള ഏതെങ്കിലും ഒന്നിൽ തൊട്ടാൽ പുല്ലേ , തട്ടിക്കളയും....'"""
...
def start(update, context):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("i am yavana, ഞാൻ എങ്ങനെയാണ് നിങ്ങളെ സഹായിക്കേണ്ടത്?... ")
