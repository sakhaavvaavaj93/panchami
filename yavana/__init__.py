...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("yavana-log.txt"),
...
if ENV:
    ...
    from yavana.config import Development as Config
...
client = TelegramClient("yavana", api_id, api_hash)
...
from yavana.modules.helper_funcs.handlers import CustomCommandHandler  # noqa
